#!/usr/bin/env python3
"""
Handler for: Enter Estimate Number

This module contains:
- Action: Enter estimate number in the search field
...
def action(estimate_number: str, **kwargs) -> Tuple[bool, str]:
    """Enter estimate number in the search field."""
...
def verifier(estimate_number: str = "", **kwargs) -> Tuple[bool, str, Optional[Dict[str, Any]]]:
    """Verify that the estimate number was entered correctly."""
