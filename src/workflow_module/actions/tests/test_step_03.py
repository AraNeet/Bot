...
class TestStep03TypeAgencyName(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.step = load_step_module("03_type_agency_name", "03_type_agency_name_handler")
    ...
    def test_action_success(self):
        ...
        success, msg = self.step.action(agency_name="Test Agency")
    ...
    def test_verifier_success(self):
        ...
        self.step.scanner.extract_text = MagicMock(return_value=(True, "Test Agency"))
        
        success, msg, data = self.step.verifier(agency_name="Test Agency")
        self.assertTrue(success)
    ...
    def test_verifier_failure_text_mismatch(self):
        self.mock_cv.take_screenshot.return_value = MagicMock()
        self.mock_cv.find_template_in_region.return_value = (False, 0.0, None)
        self.mock_cv.take_screenshot_and_crop.return_value = MagicMock()
        self.mock_cv.detect_underline.return_value = True
        self.step.scanner.extract_text = MagicMock(return_value=(True, "Wrong Agency"))
