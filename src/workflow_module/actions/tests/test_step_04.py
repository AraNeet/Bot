...
class TestStep04SetBeginDate(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.step = load_step_module("04_set_begin_date", "04_set_begin_date_handler")
    ...
    def test_verifier_success(self):
        ...
        success, msg, data = self.step.verifier(begin_date="01/01/2026")
        self.assertTrue(success)

    def test_verifier_failure_date_mismatch(self):
        self.mock_cv.take_screenshot_and_crop.return_value = MagicMock()
        self.step.scanner.extract_text = MagicMock(return_value=(True, "12/31/2025"))
        self.mock_verification.extract_date_from_text.return_value = "12/31/2025"
    ...
    def test_verifier_failure_ocr_error(self):
        self.mock_cv.take_screenshot_and_crop.return_value = MagicMock()
        self.step.scanner.extract_text = MagicMock(return_value=(False, "Error"))
